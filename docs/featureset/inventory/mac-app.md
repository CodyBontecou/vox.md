...
- Details:
  ...
  - Placement: append / prepend / beneath heading (heading title, level stepper 1–6, missing-heading behavior Show Error vs Create Heading, position Top vs Bottom segmented picker with caption).
